...
parser.add_argument(
    "--steps", type=int, default=10, help="number of steps (default: 3600)"
)
parser.add_argument(
...
for i in world.intersections:
    ...
    agents.append(MaxPressureAgent(action_space, i.id, i))
...
def train(args):
    for e in range(args.episodes):
        ...
        travel_time_record = []
        throughput_record = []
        print('maxpressure', " |episodes is : ", e)
        reward_list = []
        dic_actions = {} 
        ...
        dir_name = 'train_log/5-30/%s/%s/mp/%s/' % (net, flow, e)
