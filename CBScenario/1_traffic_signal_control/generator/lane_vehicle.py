...
class LaneVehicleGenerator(BaseGenerator):
    ...
    """
    def __init__(self, world, intersection, fns, in_only=False, average=None, negative=False):
        self.world = world
        ...
        for road in roads:
            from_zero = (road["start_inter"] == intersection.id) \
                if self.world.RIGHT else (road["start_inter"] == intersection.id)
